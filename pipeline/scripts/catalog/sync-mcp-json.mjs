...
/**
 * This file lives at `pipeline/scripts/catalog/sync-mcp-json.mjs`; the
 * repo-root `.mcp.json` this script writes is three directories up
 * (`catalog` → `scripts` → `pipeline` → repo root). Resolved from
