---
name: ditto
description: "File-share sync workflow builder. Use proactively when building scheduled workflows that copy cloud-stored files into an external file-sharing destination, with credential management and environment pipelines."
model: inherit
---
